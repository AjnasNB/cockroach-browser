...
## Capability states
- Available: implemented in the 0.1.1 runtime or shipped deployment surface.
...
<main id="main" class="docs-layout">
  ...
  <article class="docs-main">
    ...
    <div class="callout" id="status-model"><strong>Read the status</strong><p>Available means shipped in 0.1.1. Adapter means this package ships the integration contract but another package or host authority is required. Planned means the direction is documented and is not part of the current release.</p></div>
